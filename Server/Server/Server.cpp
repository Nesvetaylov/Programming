...
int main() {
	...
	const char* nameR = "C:/Users/Администратор/Desktop/Client/Client/REQUEST.bin"; //файл запросов клиентов
	const char* nameA = "C:/Users/Администратор/Desktop/Client/Client/ANSWER.bin"; //файл ответов сервера
